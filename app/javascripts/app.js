...
window.submitVote = function(candidate) {
  ...
  $("#msg").html("投票已提交。一旦投票记录在区块链上，投票数量就会增加，请稍等。")
...
window.voteForCandidate = function(candidate) {
  ...
  web3.currentProvider.sendAsync({
    ...
    $("#msg").html("用户想要投票给" + candidateName + ". 现在任何人都可以代表这个用户往区块链投票，请使用下面的值向区块链提交投票");
    $("#vote-for").html("数据提供者昵称: " + candidateName);
    $("#addr").html("你的地址: " + from);
    $("#signature").html("签名: " + result.result);
